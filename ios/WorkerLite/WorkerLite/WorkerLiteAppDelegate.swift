...
extension Notification.Name {
    static let workerLitePushPayload = Notification.Name("WorkerLitePushPayload")
}

final class WorkerLiteAppDelegate: NSObject, UIApplicationDelegate {
    func application(
