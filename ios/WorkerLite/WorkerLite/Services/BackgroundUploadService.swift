...
private final class UploadTaskMappingStore {
    ...
    private var fileURL: URL? {
        ...
        let sub = dir.appendingPathComponent("WorkerLite", isDirectory: true)
...
final class BackgroundUploadService: NSObject {
    ...
    private let pendingDir: URL? = {
        ...
        let sub = dir.appendingPathComponent("WorkerLite", isDirectory: true).appendingPathComponent("upload_pending", isDirectory: true)
