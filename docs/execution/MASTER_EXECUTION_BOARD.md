...
| Phase 4 — Product Truth Hardening | OPEN | Slice 1 implemented (smoke auth fallback logic), but closure still blocked by missing staging fallback secrets for `ops/metrics` smoke auth. | Phase 3 |
