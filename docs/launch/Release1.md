...
- **Latest staging validation (2026-04-07):** deploy run `24106627305` green; v1 compatibility routes for `/api/v1/auth/login` and `/api/v1/analysis/process` are published. End-to-end API path now reaches analysis processor and fails only on external AI env: `503 AI_ANALYSIS_URL is not configured`.
