...
1. Fill this card (or copy `docs/launch/pilot-intake.template.json` → `pilot-intake.local.json` **gitignored**).
2. Validate: `node scripts/pilot/validate_pilot_intake.mjs path/to/your-intake.json`
