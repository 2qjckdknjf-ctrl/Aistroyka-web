...
| H-05 | Legacy API surface coexists with canonical `/api/v1` | `docs/audit/LEGACY_API_SURFACE_INVENTORY.md`; dashboard projects UI on v1 (2026-06-17) | Drift and inconsistent auth/validation behavior | Web | in_progress (dashboard migrated; legacy route handlers remain for compat) |
