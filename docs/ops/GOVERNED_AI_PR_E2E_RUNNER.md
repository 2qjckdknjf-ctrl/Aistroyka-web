...
- Vercel bypass preflight → E2E harness only (raw output encrypted and staged via run-scoped `actions/cache` for Job 3; not published as a downloadable artifact)
