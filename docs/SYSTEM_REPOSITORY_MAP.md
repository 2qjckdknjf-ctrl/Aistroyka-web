...
- **v1:** `/api/v1/health`, `/api/v1/config`, `/api/v1/projects`, `/api/v1/projects/:id/field-daily-logs` (+ `/:logId`, `/:logId/confirm`), `/api/v1/projects/:id/copilot/chat/threads` (+ `/:threadId`; stream remains `/copilot/chat/stream`), `/api/v1/ai/analyze-image` (re-exports `/api/ai/analyze-image`), `/api/v1/ai/analyze-video-daily`, `/api/v1/jobs/process`, `/api/v1/sync/bootstrap`, `/api/v1/sync/changes`, `/api/v1/sync/ack`, `/api/v1/media/upload-sessions`, `/api/v1/media/upload-sessions/[id]/finalize`, `/api/v1/media/[mediaId]/annotations|comments|collab`, `/api/v1/reports/[id]/analysis-status`, `/api/v1/worker`, `/api/v1/worker/tasks/today`, `/api/v1/worker/day/start|end`, `/api/v1/worker/report/create|add-media|submit`, `/api/v1/worker/sync`, `/api/v1/devices/register|unregister`, `/api/v1/billing/*`, `/api/v1/org/*`, `/api/v1/admin/*` (many sub-routes), `/api/v1/scim/[...path]`. See `docs/API-v1-ENDPOINTS.md`.
