...
- **403/404/409/5xx:** Android Worker/Manager now map common API statuses and `lite_client_path_forbidden` to user-friendly localized messages (`en/ru/es/it`) instead of raw backend text where possible.
