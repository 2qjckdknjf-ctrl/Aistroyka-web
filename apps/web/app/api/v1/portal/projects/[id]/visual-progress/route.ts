/**
 * GET /api/v1/portal/projects/:id/visual-progress — owner before/after visual progress.
 */
...
import { getOwnerPortalVisualProgress } from "@/lib/domain/portal/owner-evidence.service";
...
export async function GET(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const { data, error } = await getOwnerPortalVisualProgress(supabase, ctx, projectId);
