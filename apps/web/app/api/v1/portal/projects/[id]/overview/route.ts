/**
 * GET /api/v1/portal/projects/:id/overview — owner portal overview slice.
 */
...
import { getOwnerPortalOverview } from "@/lib/domain/portal/owner-evidence.service";
...
export async function GET(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const { data, error } = await getOwnerPortalOverview(supabase, ctx, projectId);
