...
export async function POST(request: Request) {
  ...
  // Remove the app-side mirror first and require a real deleted row. If the external
  // Supabase Auth unlink fails, restore the mirror so the two identity stores do not drift.
