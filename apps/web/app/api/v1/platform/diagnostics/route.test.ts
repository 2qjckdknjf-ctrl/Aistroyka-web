...
describe("app/api/v1/platform/diagnostics/route.test.ts", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe("GET /api/v1/platform/diagnostics", () => {
    it("calls requirePlatformOwnerApi first with mode read", async () => {
      ...
      const res = await GET(requestFor("/api/v1/platform/diagnostics", "GET"));
