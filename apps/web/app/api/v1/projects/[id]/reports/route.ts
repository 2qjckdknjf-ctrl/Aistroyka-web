...
import { listProjectReports } from "@/lib/domain/projects/project-scoped.repository";

export const dynamic = "force-dynamic";

/** GET /api/v1/projects/:id/reports — list reports for project (by project members). Paginated. */
export async function GET(
  ...
  const { rows, total } = await listProjectReports(supabase, ctx.tenantId!, projectId, {
    limit,
    offset,
  });
