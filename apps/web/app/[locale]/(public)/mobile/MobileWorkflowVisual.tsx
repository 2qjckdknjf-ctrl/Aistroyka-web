...
type MobileWorkflowVisualProps = {
  label: string;
  title: string;
  layers: MobileWorkflowLayer[];
};

/** Mobile hero workflow diagram — not the homepage site lens. */
export function MobileWorkflowVisual({ label, title, layers }: MobileWorkflowVisualProps) {
  return (
