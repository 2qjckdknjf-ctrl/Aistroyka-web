  ...
  return (
    <div className="space-y-4 p-4">
      <p className="text-sm text-aistroyka-text-secondary">
        Post-handover warranty and aftercare — not a company-wide helpdesk. Requests are tracked after handover or completion.
      </p>
      ...
      {rows.length === 0 && !listQuery.isPending ? (
        <p className="text-sm text-aistroyka-text-secondary">No aftercare requests yet.</p>
      ) : null}
    </div>
  );
}
