...
import { aiRequestStatusBadgeClass, formatStatusLabel } from "../statusBadgeStyles";
        ...
        <TableBody>
          {(data ?? []).map((r) => (
            <TableRow key={r.id}>
              ...
              <TableCell>
                <Badge className={aiRequestStatusBadgeClass(r.status)}>{formatStatusLabel(r.status)}</Badge>
              </TableCell>
