  ...
  return (
    <Card className="mb-aistroyka-8 border-l-4 border-l-aistroyka-info p-4">
      <div className="flex flex-wrap items-center gap-2 justify-between">
        <div>
          <h2 className="text-aistroyka-title3 font-semibold text-aistroyka-text-primary">Portfolio review pack</h2>
      ...
      {pack.governanceEscalations && pack.governanceEscalations.openCount > 0 ? (
        <p className="mt-3 text-sm text-aistroyka-text-secondary border-t border-aistroyka-border-subtle pt-3">
          <strong>{pack.governanceEscalations.openCount}</strong> open cross-project governance case(s)
      ...
      {pack.commercialSignals && pack.commercialSignals.overdueCount > 0 ? (
        <p className="mt-3 text-sm text-aistroyka-text-secondary border-t border-aistroyka-border-subtle pt-3">
          <strong>{pack.commercialSignals.overdueCount}</strong> commercial billing line(s) overdue or unpaid past due date
          {pack.commercialSignals.openUnpaidCount > 0
            ? ` (${pack.commercialSignals.openUnpaidCount} open unpaid lines)`
            : ""}
          . Review project Commercial tabs.
        </p>
      ) : null}
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        <div>
          <p className="text-aistroyka-caption font-semibold uppercase text-aistroyka-text-tertiary mb-2">Critical projects</p>
          {pack.criticalProjects.length === 0 ? (
            <p className="text-sm text-aistroyka-text-tertiary">None in current sample.</p>
          ) : (
        ...
        <div>
          <p className="text-aistroyka-caption font-semibold uppercase text-aistroyka-text-tertiary mb-2">Attention projects</p>
      ...
      <div className="mt-4 rounded border border-aistroyka-border-subtle p-3">
        <p className="text-aistroyka-caption font-semibold uppercase text-aistroyka-text-tertiary mb-2">Action focus</p>
        ...
        <p className="mt-2 text-xs text-aistroyka-text-tertiary">
          Healthy projects in sample: {pack.healthyCount} · Snapshot limited to {pack.distribution.limitedTo} of{" "}
          {pack.distribution.totalProjects} total.
        </p>
      </div>
    </Card>
  );
