...
test.describe("Phase 3E worker web", () => {
  test("member role, limited project, no admin/platform controls", async ({ page }) => {
    ...
    await expect(page.locator("body")).not.toContainText(/Operations Center|Platform admin|tenant admin/i);
    ...
    expect(denied, "worker must not use tenant /admin").toBeTruthy();
