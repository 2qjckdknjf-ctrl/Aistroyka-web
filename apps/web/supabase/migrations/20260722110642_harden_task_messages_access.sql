...
-- Also limit direct PostgREST updates to the soft-delete column so an allowed
-- sender/moderator cannot rewrite message content or ownership metadata.
...
grant update (deleted_at) on table public.task_messages to authenticated;
