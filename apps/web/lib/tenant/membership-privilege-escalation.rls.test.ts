...
const migration = readFileSync(
  join(
    __dirname,
    "../../supabase/migrations/20260805120000_block_membership_privilege_escalation.sql"
  ),
  "utf8"
);
...
describe("membership privilege-escalation RLS", () => {
  ...
  it("installs a BEFORE UPDATE trigger that blocks unauthenticated role escalation", () => {
