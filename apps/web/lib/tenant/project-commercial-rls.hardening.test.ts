...
const MIGRATION = resolve(
  __dirname,
  "../../supabase/migrations/20260806120000_harden_project_role_proof_and_commercial_writes.sql"
);

describe("project commercial / proof / membership RLS hardening migration", () => {
  ...
  it("keeps portal open-defect insert while requiring tenant match", () => {
