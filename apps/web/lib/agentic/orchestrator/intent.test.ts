...
describe("intent routing", () => {
  ...
  it("routes Russian and English site-status questions only to bounded site intelligence reads", () => {
    ...
    expect(skills).toEqual(["get_project_state", "get_recent_reports", "get_site_observations"]);
